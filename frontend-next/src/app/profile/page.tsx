...
import PatientsInfo from '../../components/patient/PatientsInfo'
import { 
  Smartphone, 
  Mail, 
  Phone, 
...
const MyProfile = () => {
    ...
    const handleMedicalConditionChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const getImageSrc = () => {
        ...
        return safeUserData.image || assets.profile_pic
    }
        ...
        <div className='max-w-4xl flex flex-col gap-6 pt-5 mx-auto px-4' style={{ color: colors.textDark }}>
            ...
            <div className='flex flex-col md:flex-row items-start md:items-center gap-6 p-8 rounded-2xl shadow-sm' 
                ...
                {isEdit ? (
                    <label htmlFor='image' className='cursor-pointer group'>
                        <div className='inline-block relative'>
                            <div className='w-32 h-32 rounded-full object-cover border-4 border-white shadow-lg transition-all duration-300 group-hover:scale-105 relative overflow-hidden'>
                                <Image 
                                    src={getImageSrc()} 
                                    alt="Profile" 
                                    fill
                    ...
                    <div className='relative'>
                        <div className='w-32 h-32 rounded-full object-cover border-4 border-white shadow-lg relative overflow-hidden'>
                            <Image 
                                src={safeUserData.image || assets.profile_pic} 
                                alt="Profile" 
                                fill
                                className='object-cover'
                            />
                ...
                <div className='flex-1'>
                    {isEdit ? (
                        <input 
                            className='text-3xl font-bold mb-3 px-4 py-2 rounded-lg border-2 w-full max-w-md transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent' 
                            style={{ 
                        ...
                        <div>
                            <p className='font-bold text-3xl mb-2' style={{ color: colors.primary }}>
                                {safeUserData.name || 'No Name'}
                            </p>
                        </div>
                    )}
                        ...
                        <div>
                            ...
                            {isEdit ? (
                                ...
                                <p className='font-medium' style={{ color: colors.primary }}>
                                    {safeUserData.phone || 'Not provided'}
                                </p>
                            )}
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            {isEdit ? (
                                ...
                                <div className='flex items-center gap-3'>
                                    ...
                                    <p className='font-medium' style={{ color: colors.textLight }}>
                                        {safeUserData.gender || 'Not provided'}
                                    </p>
                                </div>
                            )}
                        </div>
                    ...
                    <div className='bg-white p-6 rounded-xl shadow-sm border transition-all duration-300 hover:shadow-md' style={{ borderColor: colors.border }}>
                        ...
                        <div className='space-y-4'>
                            <div className='flex justify-between items-center py-3 px-4 rounded-lg' style={{ backgroundColor: colors.background }}>
                                ...
                                {isEdit ? (
                                    <input 
                                        className='w-32 px-3 py-2 rounded-lg border transition-all focus:ring-2 focus:ring-blue-500 focus:border-transparent' 
                                        style={{ borderColor: colors.border }}
                                        type="text" 
                                        placeholder="e.g., 5'9&quot;"
