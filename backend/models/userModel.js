...
const userSchema = new mongoose.Schema({
  ...
  dob: { type: String, default: '' }, // or Date type if you want
  ...
  dietPreference: { type: String, default: 'Not Selected' },
  activityLevel: { type: String, default: 'Not Selected' },
  exerciseRoutine: { type: String, default: 'None' },
  sleepDuration: { type: String, default: '' },
  alcoholOrSmoking: { type: String, default: 'No' },

  // 🔹 Goal / Personalization
  healthGoal: { type: String, default: 'General Fitness' },
